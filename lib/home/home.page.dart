                              ...
                              children: [
                                ...
                                InkWell(
                                  onTap: (){
                                    ...
                                    Navigator.push(context, MaterialPageRoute(builder: (context)=>ViewAllPage(true)));
                                  },
                                  child: Container(
                                    width: 65.w,
                                    height: 26.h,
...
false
                          ...
                          AllProductBody(searchQuery: _searchQuery, key: ValueKey(_searchQuery)),
                        ],
                      ),
                    ),
    ...
    return MaterialButton(
      ...
      child: Column(
        ...
        children: [
          Icon(
            icon,
            color: isSelected ? const Color.fromARGB(255, 137, 26, 255) : const Color.fromARGB(255, 97, 91, 104),
            size: 26.sp,
          ),
          Text(
            label,
