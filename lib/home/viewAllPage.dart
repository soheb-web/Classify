      ...
      Scaffold(
        body: Stack(
          children: [
            ...
            Positioned(
              top: MediaQuery.of(context).padding.top + 20.h, // Status bar + margin
              left: 20.w,
              right: 20.w,
              child: Row(
            ...
            Positioned(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: MediaQuery.of(context).padding.top + 80.h), // Adjust if needed (header height ~80h)
                      ...
                      child: homepageData.when(
                        data: (listing) {
                          return ListView.builder(
                            ...
                            padding: EdgeInsets.zero, // Horizontal padding items में
                            scrollDirection: Axis.vertical,
                            physics: AlwaysScrollableScrollPhysics(), // Refresh के लिए जरूरी
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return Padding(
                                padding: EdgeInsets.only(top: 21.h, left: 20.w, right: 20.w), // Item padding
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                        ...
                                        Positioned(
                                          ...
                                          child: GestureDetector(
                                            ...
                                            child: Container(
                                              ...
                                              child: Center(
                                                child: Icon(
                                                  product.userlike ?? false ? Icons.favorite : Icons.favorite_border,
                                                  color: product.userlike ?? false ? Colors.red : Colors.grey,
                                                  size: 18.sp,
                                                ),
                                              ),
                                            ),
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              product.listingType == "Free"
                                                  ...
                                                  : product.listingType == "city"
                                                  ? "City"
                                                  : product.listingType == "state"
                                                  ? "State"
                                                  : "Country",
                                              style: GoogleFonts.dmSans(
                                                fontSize: 12.sp,
