...
class _ChatService implements ChatService {
  ...
  @override
  Future<InboxListResponse> getInboxs(String id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<InboxListResponse>(
    ...
    late InboxListResponse _value;
    try {
      _value = InboxListResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  @override
  Future<MessageListResponse> getMessage(String userid1, String userid2) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
